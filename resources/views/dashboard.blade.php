            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <h4 class="mb-0 mr-3">{{ trans('dash.post') }}</h4>
                        @endif
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">Levels</p>
                                    <h4>{{ $dd }}</h4>
                                </div>
                            </div>
                            <a href="{{ route('level.index') }}" class="text-muted pt-5 mb-0 mt-2 border-top">
                            <p class="text-muted pt-2 mb-0 mt-2 border-top">see more</p>
                        </a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <a href="{{ route('classroom.index') }}" class="text-muted pt-5 mb-0 mt-2 border-top">
                                <p class="text-muted pt-2 mb-0 mt-2 border-top">see more</p>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <a href="{{ route('teacher.index') }}" class="text-muted pt-5 mb-0 mt-2 border-top">
                                <p class="text-muted pt-2 mb-0 mt-2 border-top">see more</p>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <a href="{{ route('subject.index') }}" class="text-muted pt-5 mb-0 mt-2 border-top">
                                <p class="text-muted pt-2 mb-0 mt-2 border-top">see more</p>
                            </a>
                        </div>
                    </div>
  ...
  <div class="card-body">
    <blockquote class="blockquote mb-0">
      ...
      <div style="float:left">
        <a href="{{route('post.edit',$posts->id)}}" style="color:red"><i class="fas fa-edit"></i></a>
        <form action="{{route('post.destroy',$posts->id)}}" style="display:inline; color=red" method="post">
        @csrf
        @method('delete')
...
<div class="row">
            <div class="col-6">
                <div class="card text-white bg-success mr-5 mb-3" style="max-width: 30rem;">
                    <div class="card-header" style="color:black">{{ $dd->users->name }}</div>
                    <div class="card-body">
                    <p class="card-text">{{ $dd->content }}</p>
                    </div>
            </div>
        </div>
</div>
