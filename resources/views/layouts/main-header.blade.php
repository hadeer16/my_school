 ...
 header start-->
        <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <div class="text-left navbar-brand-wrapper">
                ...
                <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{ asset('assets/images/logo-icon-white.png') }}"
                        alt=""></a>
            </div>
            <!-- Top bar left -->
            ...
            <ul class="nav navbar-nav">
                <ul style="list-style: none;">
                    <li class="nav-item dropdown">
                        <p style="background-color:#3E8E7E; color:white; padding:10px;border-radius:5px">{{ trans('main-side.choose') }}<i class="fas fa-sort-down"></i></p>
                ...
                <li class="nav-item dropdown mr-30">
                    ...
                    <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button"
                        ...
                        <img src={{ asset("assets/images/user-bg.jpg") }} alt="avatar"/>
                    </a>
                    @endif
                    @if(auth()->user()->catogry=='teacher')
                    <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button"
                        aria-haspopup="false" aria-expanded="false">
                        <img src={{ asset("images/".auth()->user()->teachers->image) }} alt="avatar"/>
                    </a>
                    @endif
